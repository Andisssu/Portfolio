<template>
  <section ref="skillsSection" class="skills-section px-4 py-16 text-white relative overflow-hidden" id="habilidades">
    ...
    <!-- Skills grid -->
    <div
      class="relative z-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 justify-items-center max-w-6xl mx-auto"
      ref="skillsGrid">
      <div v-for="(skill, index) in filteredSkills" :key="index" class="skill-card group" data-skill-item>
        <div class="flex flex-col items-center w-full">
          ...
          <div class="mt-2 w-16 h-1 rounded-full bg-[#ffffff20] overflow-hidden">
            <div
              class="skill-bar h-full bg-gradient-to-r from-[#47c5ff] to-[#0098df] transition-all duration-1000 ease-out"
